    ...
    const steps = [
        {
            ...
            color: "#FFC4B2",
            accentColor: "#E65930",
            description: "Every successful project starts with clarity. As an owner, you define what you need, your goals, timeline, and budget. As a creator, you define what you offer, your skills, availability, and working style. Clear definitions on both sides create strong alignment, reduce confusion, and make sure the right opportunities connect with the right people.",
        },
        {
            number: "02",
            title: "Design",
            color: "#FFE8AF",
            accentColor: "#E69A30",
            description: "Now the idea starts taking shape. As an owner, you design the right demand by refining your brief, expectations, and outcomes so creators know exactly what you need. As a creator, you design your presence — building a strong profile and portfolio that highlights your skills and style. This stage ensures the right fit happens before work begins.",
        },
        {
            number: "03",
            title: "Collaborate",
            color: "#EFBDFF",
            accentColor: "#D34BFF",
            description: "This is where owners and creators work as a team. Use a shared workspace to communicate, share files, give feedback, and track milestones without losing context. You stay aligned, progress stays visible, and decisions happen faster. Clear collaboration builds trust, reduces friction, and keeps your project moving forward with steady momentum",
        },
        {
            number: "04",
            title: "Build",
            color: "#B9B9FF",
            accentColor: "#5A5AFF",
            description: "The work is coming to life.  Creators execute the plan, designing, coding, writing, or building with precision and focus. Progress follows clear milestones, and quality stays front and center. Owners can track updates while experts deliver polished results, turning approved ideas into tangible outcomes ready for the real world.",
        },
        {
            number: "05",
            title: "Launch",
            color: "#C6EFFF",
            accentColor: "#67D4FF",
            description: "First you learn, now you earn. It’s time to go live. Your deliverables are deployed, published, or handed over after final checks to ensure everything performs as it should. This isn’t the end, it’s the beginning of real-world impact. You walk away with results built to grow, scale, and create meaningful value from day one.",
        },
    ];
